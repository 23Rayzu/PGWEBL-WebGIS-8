    ...
    <script>
        ...
        map.on('draw:edited', function(e) {
            ...
            layers.eachLayer(function(layer) {
                ...
                $('#preview-image-point').attr('src', "<?php echo e(asset('storage/images')); ?>/" + properties.image);
            ...
            onEachFeature: function(feature, layer) {
                ...
                layer.on({
                    click: function(e) {
                        ...
                        $('#description').val(properties.description);
                        $('#geom_point').val(objectGeometry);
                        $('#preview-image-point').attr('src', "<?php echo e(asset('storage/images')); ?>/" +
                            properties.image);
                        $('#editpointModal').modal('show');
                    },
                });
        ...
        $.getJSON("<?php echo e(route('api.point', $id)); ?>", function(data) {
            point.addData(data);
            map.addLayer(point);
...
<?php echo $__env->make('layout.template', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\example-app\resources\views/editpoint.blade.php ENDPATH**/ ?>